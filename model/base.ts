...
//T在這個階段，先不給他真正的型別;而是等到其他繼承他的Class要用的時候再傳入型別
// database transaction, 資料庫交易 => 保證多筆的database 操作，能夠一起完成或是一起失敗
// select 找一筆訂單, update 將錢轉出, create 創建log, select 找出更新後的訂單 ...
